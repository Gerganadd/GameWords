...
{	
	...
	public static final int POINTS_X = TEXT_X;
	public static final int POINTS_Y = TEXT_Y + TEXT_HEIGHT;
	public static final int POINTS_WIDTH = 100;
	public static final int POINTS_HEIGHT = TEXT_HEIGHT;
